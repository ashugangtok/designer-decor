      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="animate-slide-in-left">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            About Bespoke Spaces
          </h2>
          <p className="text-lg text-muted-foreground mb-4">
            Welcome to Bespoke Spaces, where your vision for a perfect interior comes to life. As a family-run business with over a decade of experience, we pride ourselves on delivering exceptional quality and personalized service.
          </p>
          <p className="text-lg text-muted-foreground mb-4">
          ...
          <p className="text-lg text-muted-foreground">
            At Bespoke Spaces, we believe in the power of customization. Every detail matters, and our commitment to quality craftsmanship ensures that you receive products that are built to last and designed to inspire.
          </p>
        </div>
        <div className="animate-slide-in-right">
          <Image
            src="https://placehold.co/600x450"
            alt="Bespoke Spaces shop owner or storefront"
            width={600}
            height={450}
